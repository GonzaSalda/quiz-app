...
const ClassPage = () => {
  ...
  const algo = imgs.filter(img => img === `/src/assets/${classl2.toLowerCase()}.jpg`)

  const [questionsFiltered, SetQuestionsFiltered] = useState(questions.filter(question => question.category === classl2))
              ...
              <>
                 <div className="flex flex-col gap-5">
                    ...
                    <div className="flex justify-center items-center">
                      <img src={algo } alt={classl2} className="w-72"/>
                    </div>
                  </div>              
